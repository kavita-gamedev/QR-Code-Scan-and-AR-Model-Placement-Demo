...
#pragma warning restore 4014
        ...
        void OnApplicationPause(bool isPaused)
        {
            ...
            Debug.Log("HTTPUpdateDelegator OnApplicationPause" + isPaused + "scene" + scene.name);
            if (scene.name == "gameplay")
            {
                Debug.Log("current scene  HTTPUpdateDelegator OnApplicationPause" + isPaused);
            }
            else
            {
        ...
        void OnApplicationQuit()
        {
            ...
            Debug.Log("HTTPUpdateDelegator LOGGER  OnApplicationQuit");
